...
When adding people, the commit message should be of the format: `Added @[github handle1], @[github handle2]`, (if their github account exists). Example: `Added @fat, @adrianholovaty`
